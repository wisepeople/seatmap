<template>
    <div class="contents">
        ...
        <template v-if="!isLoading&&travelers&&currentSegment">
            ...
            <seatmap-segment :travelers="travelers" :popoverId="popoverId" :flights="flights" :currentSegment="currentSegment" @changePopoverState="onChangePopoverState"></seatmap-segment>
...
import {SeatAssignFlights, SeatAssignFlight} from '../Model/SeatAssignFlights'
// import {Test} from '../components/test'
import {SeatAssignTraveler, SeatAssignTravelers} from '../Model/SeatAssignTravelers'
    ...
    methods:{
        ...
        onSuccessOrder(resp: { status: string; data: any }){
            if(resp.status == '200'){
                ...
                //                                 _arr[_i]= _.extend({}, _v2, this.order.dictionaries[_key][_v2.id]);
                //                                 // _info[_key][_k] = _v;
                //                             }
                ...
                //                         _info[_key] = _.extend({code:_v}, this.order.dictionaries[_key][_v]);
                //                         // _info[_key][_k] = _v;
                //                     }
                //                 }
                //                 break;
                ...
                const _flightsData = _.reduce(_cvtedData.air.bounds, (_arr, _bound, _bi)=>{
                    return _.reduce(_bound.flights, (_arr, _fl, _fi)=>{
